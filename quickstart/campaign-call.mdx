...
Once a campaign is created, targets must be added using the following endpoint:
...
After adding targets, execute calls by specifying which targets to include:
