...
<CardGroup cols={2}>
  <Card title="Make an inbound call" icon="phone-arrow-down-left" href="quickstart/inbound-call">
    Create the first inbound call
  </Card>
  <Card title="Make an outbound call" icon="phone-arrow-up-right" href="quickstart/outbound-call">
